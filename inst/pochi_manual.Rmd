---
title: "pochi"
shorttitle: "pochi function manual"
author: "Diego A. Espinoza"
package: pochi
date: (`r format(Sys.Date(), "%d %B %Y")`)
abstract: > 
    [pochi](http://github.com/diegoalexespi/pochi) is an R package developed for the supplementation of analysis and visualization of single-cell -omics data with [Seurat](http://github.com/satijalab/Seurat).
output:
  html_document
 ---
...
```{r loading pbmc3k data, eval = TRUE}
pbmc3k_seurat <- pbmc3k.SeuratData::pbmc3k.final
set.seed(789)
...
```{r AbundancePlot, eval=TRUE, fig.width = 7, fig.height=4}
